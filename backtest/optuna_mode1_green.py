...
RESULTS_PATH = Path("/Users/raymondghandchi/Mancini/Mancini/data/optuna_mode1_green_results.json")
...
def main():
    ...
    storage = f"sqlite:////Users/raymondghandchi/Mancini/Mancini/data/optuna_mode1_green.db"
