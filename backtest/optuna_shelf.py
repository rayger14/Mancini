...
RESULTS_PATH = Path("/Users/raymondghandchi/Mancini/Mancini/data/optuna_shelf_results.json")
...
def main():
    ...
    storage = f"sqlite:////Users/raymondghandchi/Mancini/Mancini/data/optuna_shelf.db"
